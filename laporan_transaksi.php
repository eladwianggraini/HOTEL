...
$sql = "SELECT customer.namacustomer, kamar.namakamar, pesan.tglmasuk, pesan.tglkeluar, kategori.kategori, kategori.harga FROM pesan JOIN (kamar JOIN kategori ON kamar.idkategori=kategori.idkategori )ON pesan.idkamar=kamar.idkamar JOIN customer ON pesan.idcustomer=customer.idcustomer";
